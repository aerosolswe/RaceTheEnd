...
public class Sport extends Car {
    ...
    public Sport(RayHandler rayHandler, World world, String color, String wheel, float x, float y) {
        ...
        float wheelSize = 0.38f;

        float wheelY = (-height / 2) + 0.05f;

        Vector2 wheelPos1 = new Vector2(-width / 2 * 0.57f, wheelY);
        Vector2 wheelPos2 = new Vector2(width / 2 * 0.61f, wheelY);

        TextureAtlas chassi = SplashScreen.assetManager.get("cars/sport/sport.pack");
