...
public class Pickup extends Car {
    ...
    public static float wheelFriction = 50;
    public static float health = 150;

    public Pickup(RayHandler rayHandler, World world, String color, String wheel, float x, float y) {
        ...
        float wheelY = (-height / 2) - 0.2f;

        Vector2 wheelPos1 = new Vector2(-width / 2 * 0.5f, wheelY);
        Vector2 wheelPos2 = new Vector2(width / 2 * 0.68f, wheelY);

        TextureAtlas chassi = SplashScreen.assetManager.get("cars/pickup/pickup.pack");
