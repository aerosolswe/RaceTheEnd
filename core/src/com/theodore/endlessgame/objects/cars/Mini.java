...
public class Mini extends Car {
    ...
    public Mini(RayHandler rayHandler, World world, String color, String wheel, float x, float y) {
        ...
        Vector2 wheelPos1 = new Vector2(-width / 2 * 0.67f, wheelY);
        Vector2 wheelPos2 = new Vector2(width / 2 * 0.645f, wheelY);

        TextureAtlas chassi = SplashScreen.assetManager.get("cars/mini/mini.pack");
