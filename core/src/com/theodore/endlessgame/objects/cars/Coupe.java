...
public class Coupe extends Car {
    ...
    public Coupe(RayHandler rayHandler, World world, String color, String wheel, float x, float y) {
        ...
        float wheelSize = 0.4f;

        float wheelY = (-height / 2) + 0.05f;

        Vector2 wheelPos1 = new Vector2(-width / 2 * 0.62f, wheelY);
        Vector2 wheelPos2 = new Vector2(width / 2 * 0.62f, wheelY);

        TextureAtlas chassi = SplashScreen.assetManager.get("cars/coupe/coupe.pack");
