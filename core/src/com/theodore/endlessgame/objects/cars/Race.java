...
public class Race extends Car {

    public static float width = 4.2f;
    ...
    public Race(RayHandler rayHandler, World world, String color, String wheel, float x, float y) {
        ...
        float wheelSize = 0.42f;

        float wheelY = (-height / 2) + 0.15f;

        Vector2 wheelPos1 = new Vector2(-width / 2 * 0.62f, wheelY);
        Vector2 wheelPos2 = new Vector2(width / 2 * 0.60f, wheelY);

        TextureAtlas chassi = SplashScreen.assetManager.get("cars/race/race.pack");
