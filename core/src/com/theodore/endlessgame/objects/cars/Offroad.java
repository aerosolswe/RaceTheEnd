...
public class Offroad extends Car {
    ...
    public static float motorSpeed = 35;
    public static float wheelFriction = 70;
    public static float health = 150;

    public Offroad(RayHandler rayHandler, World world, String color, String wheel, float x, float y) {
        ...
        float wheelY = (-height / 2) - 0.1f;

        Vector2 wheelPos1 = new Vector2(-width / 2 * 0.58f, wheelY);
        Vector2 wheelPos2 = new Vector2(width / 2 * 0.68f, wheelY);

        TextureAtlas chassi = SplashScreen.assetManager.get("cars/offroad/offroad.pack");
