...
public class Hatchback extends Car {
    ...
    public static float motorSpeed = 40;
    public static float wheelFriction = 70;
    public static float health = 120;

    public Hatchback(RayHandler rayHandler, World world, String color, String wheel, float x, float y) {
        ...
        float wheelY = (-height / 2) - 0.0f;

        Vector2 wheelPos1 = new Vector2(-width / 2 * 0.56f, wheelY);
        Vector2 wheelPos2 = new Vector2(width / 2 * 0.63f, wheelY);

        TextureAtlas chassi = SplashScreen.assetManager.get("cars/hatchback/hatchback.pack");
